            ...
            <div className="row">
              <div className="col-lg-6">
                <Form.Group className="mb-3">
                  ...
                  <Form.Select   onChange={(e) => setCertIncorRegi(e.target.files[0])}>
                    <option></option>
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Control type="file"   onChange={(e) => setCertIncorRegi(e.target.files[0])} />
                </Form.Group>
              ...
              <div className="col-lg-6">
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Control type="text"    onChange={(e) => setCertIncorRegi(e.target.files[0])}/>
                </Form.Group>
              </div>
            </div>
