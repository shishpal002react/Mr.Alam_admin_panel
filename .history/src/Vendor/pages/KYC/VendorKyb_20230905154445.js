            ...
            <div className="row">
              <div className="col-lg-6">
                <Form.Group className="mb-3">
                  ...
                  <Form.Select
                    onChange={(e) => setUBOs(e.target.value)}
                  >
                    <option></option>
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Select
                    onChange={(e) => setUsEIN(e.target.value)}
                  >
                    <option></option>
                    <option value="true">Yes</option>
                    <option value="false">No</option>
                ...
                <Form.Group className="mb-3">
                  <Form.Label>setUboStatOfInformation</Form.Label>
                  <Form.Control
                    type="file"
                    onChange={(e) => setExcerptStateCompanyRegi(e.target.files[0])}
                  />
                </Form.Group>
                <Form.Group className="mb-3">
              ...
              <div className="col-lg-6">
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    type="file"
                    onChange={(e) => setUboExcerptStateCompanyRegi(e.target.files[0])}
                  />
                </Form.Group>
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    type="file"
                    onChange={(e) => setUboCertIncorIncumbency(e.target.files[0])}
                  />
                </Form.Group>
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    type="text"
                    onChange={(e) => setNumberEIN(e.target.files[0])}
                  />
                </Form.Group>
              </div>
            </div>
