      ...
      <section>
        ...
        <section className="sectionCont">
          <div className="img-cont">
            ...
            <img src={data?.excerptStateCompanyRegi} alt="" className="centerImage" />
            <img src={data?.memorandum} alt="" className="centerImage" />
            <img src={data?.uboCertIncorIncumbency} alt="" className="centerImage" />
            <img src={data?.uboExcerptStateCompanyRegi} alt="" className="centerImage" />
            <img src={data?.uboMemorandum} alt="" className="centerImage" />
            <img src={data?.uboShareholderRegi} alt="" className="centerImage" />
            <img src={data?.uboStatOfInformation} alt="" className="centerImage" />
          ...
          {data?.usEIN ?  <Form.Group className="mb-3">
        <Form.Label> {data?.useEIN === true ? "Yes" : "False"} </Form.Label>
        <Form.Control placeholder={data?useEIN} disabled />
      </Form.Group> : "" }
          </Form>
        </section>
      </section>
