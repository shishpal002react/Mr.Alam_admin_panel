                  ...
                  <tbody>
                    {data?.map((i, index) => (
                      <tr key={index}>
                        ...
                        <td>
                          <img
                            src={i?.uboExcerptStateCompanyRegi}
                            alt="Aadhar Image"
                            style={{ width: "100px" }}
                          />
                        </td>
