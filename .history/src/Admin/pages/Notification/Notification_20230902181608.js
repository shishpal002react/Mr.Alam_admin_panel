...
const Notification = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const fetchProducts = async () => {
      try {
        const res = await axios.get("https://ecommerce-backend-ochre-phi.vercel.app/api/v1/admin/Product/list?page=1&limit=10&search=&toDate=null&fromDate=null&categoryId=&subcategoryId=")
          ...
          <Form onSubmit={postHandler}>
            ...
            >
              ...
              {products?.map((i ,index) => (
                <option key={index} value={i._id} > {i.productName} </option>
              ))}
            </Form.Select>
